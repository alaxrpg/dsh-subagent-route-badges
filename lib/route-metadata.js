...
const viewSchema = { parse(value) { const v = view(value); if (v === null) return null; if (!['explicit','adapter-default','unspecified'].includes(v.reasoningSource)) throw new Error('invalid route metadata'); return v; } };
